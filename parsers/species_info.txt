// Preprocessed Species Info file
// Parsing the complex macros is too complicated, will need to be updated with newer updates when applicable
...
.noFlip = FALSE,
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .expYield = 39,
        .evYield_HP = 1,
        .genderRatio = min(254, ((50 * 255) / 100)),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
...
.noFlip = 0 
    ...
    [SPECIES_CLEFAIRY] =
    {
        ...
        .genderRatio = min(254, ((75 * 255) / 100)),
        .eggCycles = 10,
        .friendship = 140,
...
.noFlip = FALSE
    ...
    [SPECIES_GROWLITHE] =
    {
        ...
        .expYield = 70,
        .evYield_Attack = 1,
        .genderRatio = min(254, ((25 * 255) / 100)),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
...
.noFlip = FALSE, 
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .expYield = 74,
        .evYield_SpAttack = 1,
        .genderRatio = min(254, ((87.5 * 255) / 100)),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD},
